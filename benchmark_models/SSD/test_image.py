...
def get_args():
    ...
    parser.add_argument("--input", type=str,default="/home/udayanga/Desktop/dog-and-cat-cover.jpg", help="the path to input image")
    ...
    parser.add_argument("--pretrained-model", type=str, default="weights/SSD.pth")
    parser.add_argument("--output", type=str, default="./results/output.png", help="the path to output image")
    args = parser.parse_args()
    return args


def test(opt):
    print("pretrained model ",opt.pretrained_model)
