...
def get_args():
    ...
    if dataset_type == "coco":
        ...
        data_path = "/dtu/eumcaerotrain/data/latest_dataset/"
        ckpt_save_folder = "/dtu/eumcaerotrain/data/SSD_Statistics/ckpt/ckpt_event_based/"
        log_path = "/dtu/eumcaerotrain/data/SSD_Statistics/log/log_event_based/"
...
if __name__ == "__main__":
    opt = get_args()
    opt.train_img_file = "night_outdoor_and_daytime_train_files_event_based.txt"
    opt.test_img_file = "test_files_event_based.txt"
    opt.nms_thres = 0.3
    opt.conf_thres = 0.02
    ...
    opt.trained_model_to_evaluate = ""  #"/media/udayanga/data_2/SSD_new_github/SSD-pytorch_2-array_based/weights/mobilenet_no_lab_0.10489204807482531.pth"  #"/media/udayanga/data_2/SSD_new_github/ckpt/ckpt_event_based/best_map_0.38206401981151644.pth"  #"/media/udayanga/data_2/SSD_new_github/SSD-pytorch_2-array_based/weights/best_map_0.246_nolab_event.pth"
    main(opt)
