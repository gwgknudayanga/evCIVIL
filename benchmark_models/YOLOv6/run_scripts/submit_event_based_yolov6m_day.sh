...
python ./tools/train.py --conf-file ./configs/yolov6m_finetune.py --save_dir /dtu/eumcaerotrain/data/YOLOv6_Statistics/yolov6m_event_based_day --input_img_type 2 --num_input_channels 2 --data-path ./data/defects.yaml > run_logs/log_event_based_all
