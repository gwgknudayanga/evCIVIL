...
python ./tools/train.py --conf-file ./configs/yolov6m_finetune.py --output-dir /dtu/eumcaerotrain/data/YOLOv6_Statistics/ --input_img_type 1 --num_input_channels 3 --data-path ./data/defects.yaml > run_logs/log_event_based_image --name event_yolov6m_image
