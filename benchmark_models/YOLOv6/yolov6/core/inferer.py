...
class Inferer:
    def __init__(self, source, webcam, webcam_addr, weights, device, yaml, img_size, half,args):
    ...
    def infer(self, conf_thres, iou_thres, classes, agnostic_nms, max_det, save_dir, save_txt, save_img, hide_labels, hide_conf, view_img=True):
        ...
        print("KKKKKKKKKKKKKKKKKKKKKKKKKKKKKK ",self.files)
    ...
    def process_image(img_src, img_size, stride, half):
        ...
        #if self.args.input_img_type == 0 & self.args.input_img_type == 1:
