...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--conf-thres', type=float, default=0.02, help='confidence threshold for inference.')
    ...
    #args.weights = "/work3/kniud/object_detection/YOLOv6/runs/train/exp10/weights/last_ckpt.pt"
    LOGGER.info(args)
    return args
...
def run(weights=None,
    ...
    # Inference
    inferer = Inferer(source, webcam, webcam_addr, weights, device, yaml, img_size, half,args)
...
if __name__ == "__main__":
    ...
    args.yaml = './data/defects.yaml'
    args.weights = "/work3/kniud/object_detection/YOLOv6/runs/train/exp1/weights/best_ckpt.pt"
    args.source = "/dtu/eumcaerotrain/data/Image_Data/yolo_nas_img_dataset/Images/test"
    args.save_dir = "runs/test"
    args.classes = ["crack","spalling"]
    
    print(args)
    #ckpt = torch.load("/work3/kniud/object_detection/YOLOv6/runs/train/field_imgs/196_ckpt.pt")
    main(args)
