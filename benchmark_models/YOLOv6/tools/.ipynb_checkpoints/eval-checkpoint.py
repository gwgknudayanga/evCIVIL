...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--weights', type=str, default='./weights/yolov6m.pt', help='model.pt path(s)')
...
def run(data,
    ...
    val = Evaler(data, batch_size, img_size, conf_thres, \
                ...
                specific_shape=specific_shape,height=height, width=width,args=args)
    ...
    print("MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD","   ",val.verbose)
...
if __name__ == "__main__":
    ...
    args.conf_thres = 0.1
    args.iou_thres = 0.4
    args.data = './data/defects.yaml'
    args.weights = "/work3/kniud/object_detection/YOLOv6/runs/train/exp/weights/best_ckpt.pt"   
    args.dataset_parent_folder = "/dtu/eumcaerotrain/data/latest_dataset_encode_benchmark_25_25" #/dtu/eumcaerotrain/data/latest_dataset/"
    #"/work3/kniud/object_detection/YOLOv6/runs/train/field_imgs/196_ckpt.pt"
    main(args)
