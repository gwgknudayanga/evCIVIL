...
python ./tools/train.py --conf-file ./configs/yolov6n_finetune.py --save_dir /dtu/eumcaerotrain/data/YOLOv6_Statistics/yolov6m_event_based_based_nolab --input_img_type 2 --num_input_channels 2 --data-path ./data/defects_event_based_nolab.yaml > run_logs/log_yolov6m_event_based_nolab
