...
python ./tools/train.py --conf-file ./configs/yolov6_lite/yolov6_lite_s_finetune.py --output-dir /dtu/eumcaerotrain/data/YOLOv6_Statistics/ --input_img_type 2 --num_input_channels 2 --data-path ./data/defects_lite.yaml > run_logs/log_event_based_lite_nolab --name event_yolov_lite_nolab
