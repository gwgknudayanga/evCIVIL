...
class TrainValDataset(Dataset):
    ...
    @staticmethod
    def generate_coco_format_labels_custom(save_path,img_paths_list,anns_for_images_list,class_names):
    ...
    def get_imgs_labels(self, img_data_csv,ann_data_csv,args):
        ...
        if self.task.lower() == "val":
            TrainValDataset.generate_coco_format_labels_custom(self.target_ann_save_path,img_file_names,anns_list_for_images,self.class_names)
