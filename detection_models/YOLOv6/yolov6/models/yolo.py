...
def build_model(cfg, num_classes, device, fuse_ab=False, distill_ns=False,num_input_channels=3):
    model = Model(cfg, channels=num_input_channels, num_classes=num_classes, fuse_ab=fuse_ab, distill_ns=distill_ns).to(device)
    return model
